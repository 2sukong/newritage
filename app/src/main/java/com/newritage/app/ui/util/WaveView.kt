...
class WaveView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        when (waveStyle) {
            ...
            WaveStyle.MEASURING -> drawMeasuringWave(canvas, w, h)

            WaveStyle.COMPLETE -> drawCompleteWave(canvas, w, h)
        ...
        borderPaint.color = when (waveStyle) {
            WaveStyle.MEASURING -> Color.parseColor("#82A68D")
            WaveStyle.COMPLETE -> Color.parseColor("#E6E8E2")
        }
        ...
        if (waveStyle == WaveStyle.MEASURING) {
